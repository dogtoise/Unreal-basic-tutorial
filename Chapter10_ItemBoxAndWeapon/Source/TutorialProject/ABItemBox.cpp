...
AABItemBox::AABItemBox()
{
	...
	Trigger->SetBoxExtent(FVector(40.0f, 42.0, 30.0f));
	...
	Box->SetCollisionProfileName(TEXT("NoColliison"));
...
void AABItemBox::PostInitializeComponents()
{
	...
	Trigger->OnComponentBeginOverlap.AddDynamic(
		this, &AABItemBox::OnCharacterOverlap);
}
	...
	if (nullptr != ABCharacter && nullptr != WeaponItemClass)
	{
		if (ABCharacter->CanSetWeapon())
		{
			auto NewWeapon = GetWorld()->SpawnActor<AABWeapon>(
				WeaponItemClass, FVector::ZeroVector, FRotator::ZeroRotator);
